-- =============================================
-- INSERT DATA SCRIPT (FIXED)
-- =============================================

-- Inserción en la tabla 'image'
-- At least 16 placeholder images for referenced img_id values
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 1
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 2
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 3
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 4
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 5
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 6
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 7
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 8
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 9
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 10
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 11
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 12
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 13
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 14
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 15
INSERT INTO image (content) VALUES (decode('', 'hex')); -- id = 16
...
-- Queen
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('A Night at the Opera', 'Rock', '1975-11-21', 12, 1); -- id = 1

INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('News of the World', 'Rock', '1977-10-28', 13, 1); -- id = 2

INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Sheer Heart Attack', 'Rock', '1974-11-08', 14, 1); -- id = 3

INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('The Game', 'Rock', '1980-06-30', 15, 1); -- id = 4

INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Innuendo', 'Rock', '1991-02-05', 16, 1); -- id = 5


-- David Bowie
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('The Rise and Fall of Ziggy Stardust', 'Rock', '1972-06-16', 1, 3); -- id = 6
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Heroes', 'Rock', '1977-10-14', 1, 3); -- id = 7
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Hunky Dory', 'Rock', '1971-12-17', 1, 3); -- id = 8
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Aladdin Sane', 'Rock', '1973-04-13', 1, 3); -- id = 9
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Low', 'Art Rock', '1977-01-14', 1, 3); -- id = 10


-- Elton John
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Goodbye Yellow Brick Road', 'Pop/Rock', '1973-10-05', 1, 4); -- id = 11
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Captain Fantastic and the Brown Dirt Cowboy', 'Pop/Rock', '1975-05-19', 1, 4); -- id = 12
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Madman Across the Water', 'Pop/Rock', '1971-11-05', 1, 4); -- id = 13
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Honky Château', 'Pop/Rock', '1972-05-19', 1, 4); -- id = 14
INSERT INTO album (title, genre, release_date, img_id, artist_id)
VALUES ('Dont Shoot Me Im Only the Piano Player', 'Pop/Rock', '1973-01-26', 1, 4); -- id = 15
...
-- Queen songs
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Bohemian Rhapsody', '5:55', 1, 1); -- id = 1
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Love of My Life', '3:39', 2, 1); -- id = 2
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('We Will Rock You', '2:01', 1, 2); -- id = 3
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('We Are the Champions', '2:59', 2, 2); -- id = 4
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Radio Ga Ga', '5:48', 1, 5); -- id = 5

-- David Bowie songs
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Ziggy Stardust', '3:13', 1, 6); -- id = 6
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Starman', '4:16', 2, 6); -- id = 7
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Heroes', '6:07', 1, 7); -- id = 8
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Changes', '3:37', 1, 8); -- id = 9
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Life on Mars?', '3:55', 2, 8); -- id = 10

-- Elton John songs
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Goodbye Yellow Brick Road', '3:14', 1, 11); -- id = 11
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Rocket Man', '4:41', 1, 14); -- id = 12
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Tiny Dancer', '6:17', 1, 13); -- id = 13
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Daniel', '3:54', 1, 15); -- id = 14
INSERT INTO song (title, duration, track_number, album_id)
VALUES ('Bennie and the Jets', '5:23', 2, 11); -- id = 15


-- =============================================
-- Inserción en la tabla 'song_artist'
-- =============================================
