...
public class UserMapper {
    ...
    public User toDomain(UserJpaEntity entity) {
        ...
        return User.reconstitute(
            ...
            entity.getPassword(),
            entity.getVerified() != null ? entity.getVerified() : false,
            entity.getIsModerator() != null ? entity.getIsModerator() : false,
            entity.getReviewAmount() != null ? entity.getReviewAmount() : 0,
            entity.getFollowerAmount() != null ? entity.getFollowerAmount() : 0,
            entity.getFollowingAmount() != null ? entity.getFollowingAmount() : 0,
            entity.getCreatedAt(),
            entity.getUpdatedAt(),
            entity.getName(),
            entity.getBio(),
