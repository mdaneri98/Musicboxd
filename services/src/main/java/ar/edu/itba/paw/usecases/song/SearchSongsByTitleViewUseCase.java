...
@Service
public class SearchSongsByTitleViewUseCase implements SearchSongsByTitleView {

    private final SongRepository songRepository;
    private final AlbumRepository albumRepository;

    @Autowired
    public SearchSongsByTitleViewUseCase(SongRepository songRepository, AlbumRepository albumRepository) {
    ...
    public List<SongView> execute(String title, Integer page, Integer size) {
        List<Song> songs = songRepository.findByTitleContaining(title, page, size);
