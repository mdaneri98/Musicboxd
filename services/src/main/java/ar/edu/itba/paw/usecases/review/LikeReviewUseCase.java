...
@Service
@Transactional
public class LikeReviewUseCase implements LikeReview {

    private final ReviewRepository reviewRepository;

    @Autowired
    public LikeReviewUseCase(ReviewRepository reviewRepository) {
        this.reviewRepository = reviewRepository;
    }

    @Override
    public void execute(Long reviewId, Long userId) {
        reviewRepository.addLike(new ReviewId(reviewId), new UserId(userId));
    }
}
