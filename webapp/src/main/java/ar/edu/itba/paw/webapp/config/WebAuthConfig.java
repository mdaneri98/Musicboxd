...
public class WebAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.sessionManagement()
                ...
                .antMatchers("/", "/images/**", "/music", "/search/**", "/user/verification", "/user/register", "/user/login", "/mod/**", "/song/{id:[\\d]+}", "/album/{id:[\\d]+}", "/artist/{id:[\\d]+}", "/user/{id:[\\d]+}", "/user/forgot-password", "/user/reset-password", "/user/language/**").permitAll()
